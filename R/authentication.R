...
##
client_ciph <- auth_encrypt(serialize_pb(shared_key), client_keys$privkey, srv_keys$pubkey)
...
b_access <- verify_access(client_ciph, srvkeys$privkey, pubkey, srv_hash)
b_access
